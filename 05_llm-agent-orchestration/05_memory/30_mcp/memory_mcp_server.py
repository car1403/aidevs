"""사용자 범위 Mock Memory를 제공하는 Streamable HTTP MCP Server입니다."""
...
store = ScopedMemoryStore(AUTHENTICATED_USER_ID)
mcp = FastMCP(
    "Memory Learning Server",
    instructions=(
...
if __name__ == "__main__":
    print(f"Memory MCP: http://{HOST}:{PORT}/mcp")
